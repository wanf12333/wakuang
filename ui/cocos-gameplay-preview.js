...
(()=>{
 ...
 function sync(){const active=window.review?.s.page==='gameplay';if(active!==document.body.classList.contains('native-gameplay-preview')){document.body.classList.toggle('native-gameplay-preview',active);if(active)select('gameplay-no-stamina');}}
