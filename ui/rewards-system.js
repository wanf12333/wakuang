...
function install(Engine,items){
 ...
 proto.perform=function(id,payload){
  ...
  if((id==='nav.back'||id==='rewards.pass.back')&&this.s.modal==='pass'&&this.s.passReturnModal==='checkin'){delete this.s.passReturnModal;this.open('checkin');return this.result(id,true,'返回签到');}
  if(id==='home.miner_pass'&&this.s.modal==='checkin'){this.s.passReturnModal='checkin';this.open('pass');return this.result(id,true,'查看VIP加成');}
